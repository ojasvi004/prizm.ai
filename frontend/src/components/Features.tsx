		...
		icon: (
			...
			>
				<path
					strokeLinecap="round"
					strokeLinejoin="round"
					d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.4-4 8-9 8a10 10 0 01-4-1l-4 1 1-4c-1-1.4-1-3-1-4 0-4.4 4-8 9-8s9 3.6 9 8z"
				/>
			</svg>
		),
	},
...
export default function Features() {
	return (
		<motion.section id="features" className="relative overflow-hidden bg-transparent py-32" initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.7, type: "spring" }}>
			{/* Ambient Grid */}
			...
			<div className="relative mx-auto max-w-7xl px-6 lg:px-8">
				...
				<header className="mx-auto mb-24 max-w-3xl text-center">
					...
					<p className="mt-6 text-lg leading-relaxed text-slate-600">
						...
						refined, and synthesized, ensuring decisions survive structured
						opposition.
					</p>
				</header>
				...
				<div className="grid gap-10 lg:grid-cols-2">
					{features.map((f) => (
						<NoiseBackground
							key={f.title}
							containerClassName="rounded-[32px] border border-white bg-white/60 backdrop-blur-md transition-all duration-300 hover:bg-white hover:shadow-xl hover:shadow-blue-900/20 shadow-lg shadow-blue-900/5 group"
